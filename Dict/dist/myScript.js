...
var savedWords = [{name : "", description:""}]
    ...
    function addWords(word){
      ...
      for (var i = 0; i<words.length; i++){
        ...
        selectBtn.setAttribute("wName", wName);
        selectBtn.setAttribute("wDescription", wDescription);
        ...
        saveBtn.setAttribute("wName", wName);
        saveBtn.setAttribute("wDescription", wDescription);
